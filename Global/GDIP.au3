...
; Syntax.........: _GDIPlus_GraphicsFillPolygon2($hGraphics, $aPoints[, $hBrush = 0])
; Parameters ....: $hGraphics - Pointer to a Graphics object
...
; Link ..........; @@MsdnLink@@ GdipFillPolygon2
; Example .......; No
; ===============================================================================================================================
Func _GDIPlus_GraphicsFillPolygon2($hGraphics, $aPoints, $hBrush = 0)
	Local $iI, $iCount, $iTmpErr, $iTmpExt, $pPoints, $tPoints, $aResult
	...
	$aResult = DllCall($ghGDIPDll, "uint", "GdipFillPolygon2", "hwnd", $hGraphics, "hwnd", $hBrush, "ptr", $pPoints, "int", $iCount)
	$iTmpErr = @error
	$iTmpExt = @extended
...
Func _GDIPlus_PathAddRectangles($hPath, $aRects)
	...
	For $iI = 1 To $iCount
		DllStructSetData($tRects, 1, $aRects[$iI][0], (($iI - 1) * 4) + 1)
		DllStructSetData($tRects, 1, $aRects[$iI][1], (($iI - 1) * 4) + 2)
		DllStructSetData($tRects, 1, $aRects[$iI][0], (($iI - 1) * 4) + 3)
		DllStructSetData($tRects, 1, $aRects[$iI][1], (($iI - 1) * 4) + 4)
	Next
...
Func _GDIPlus_PathClone($hPath)
	Local $aResult = DllCall($ghGDIPDll, "uint", "GdipClonePath", "hwnd", $hPath, "hwnd*", 0)
...
; Syntax.........: _GDIPlus_ImageSaveToStream($hImage, $pStream, $sEncoder[, $pParams = 0])
; Parameters ....: $hImage   - Pointer to an Image object
...
; Example .......; No
; ===============================================================================================================================
Func _GDIPlus_ImageSaveToStream($hImage, $pStream, $sEncoder, $pParams = 0)
	Local $pGUID, $tGUID, $aResult

	$tGUID = _WinAPI_GUIDFromString($sEncoder)
	$pGUID = DllStructGetPtr($tGUID)
	$aResult = DllCall($ghGDIPDll, "uint", "GdipSaveImageToStream", "hwnd", $hImage, "ptr", $pStream, "ptr", $pGUID, "ptr", $pParams)
...
;                  |3 - Color adjustment applies to pen operations in metafiles
;                  |4 - Color adjustment applies to text drawn in metafiles
;                  $fEnable			 - If True, color adjustment for the specified category is turned on; otherwise, color
;                  +adjustment for the specified category is turned off
; Return values .: Success      - True
;                  Failure      - False and either:
;                  |@error and @extended are set if DllCall failed
;                  |$GDIP_STATUS contains a non zero value specifying the error code
...
; Syntax.........: _WinAPI_DeleteEnhMetaFile($hEnMetaFile)
; Parameters ....: $hEnMetaFile - A handle to an enhanced metafile
; Return values .: Success      - True
;                  Failure      - False
; Remarks .......: None
; Related .......: None
...
; Example .......; No
; ===============================================================================================================================
Func _WinAPI_DeleteEnhMetaFile($hEnMetaFile)
	Local $aResult = DllCall("gdi32.dll", "int", "DeleteEnhMetaFile", "hwnd", $hEnMetaFile)
...
; Syntax.........: _WinAPI_GetEnhMetaFile($sFileName)
; Parameters ....: $sFileName - Fully qualified path of the enhanced-metafile file
; Return values .: Success      - A handle to the enhanced metafile
;                  Failure      - 0
; Remarks .......: None
; Related .......: _WinAPI_DeleteEnhMetaFile
; Link ..........; @@MsdnLink@@ GetEnhMetaFileA
; Example .......; No
; ===============================================================================================================================
Func _WinAPI_GetEnhMetaFile($sFileName)
	Local $aResult = DllCall("gdi32.dll", "hwnd", "GetEnhMetaFileA", "str", $sFileName)
